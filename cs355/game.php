...
$result->execute();
$result->store_result();
$result->bind_result($u_id,$triviaRank,$keyHunterHighScore,$phishingFrenzyHighScore,$dataDefLVL,$dataDefDay,$dataDefBalance,$dataDefFixes,$dataDefFails,$dataDefReputation);
$result->fetch();
...
<body>
                ...
                <div class="hp_bottom_left">
                    <div class="hp_table">
                        <table class="scoretable">
                            ...
                            <tr>
                                <td>Trivia Rank</td>
                                <td><?php echo $triviaRank; ?></td>
                            </tr>
                            <tr>
                                <td>Key Hunter Score</td>
                                <td><?php echo $keyHunterHighScore; ?> </td>
                            </tr>
                            <tr>
                                <td>Phish Frenzy HS</td>
                                <td><?php echo $phishingFrenzyHighScore; ?></td>
                            </tr>
                            <tr>
                                <td>Data Def. Lvl</td>
                                <td><?php echo $dataDefLVL; ?></td>
                            </tr>
                            <tr>
                                <td>Data Def. Day</td>
                                <td><?php echo $dataDefDay; ?></td>
                            </tr>
                            <tr>
                                <td>Data Def. Bal.</td>
                                <td><?php echo $dataDefBalance; ?> </td>
                            </tr>
                            <tr>
                                <td>Data Def. Fixes</td>
                                <td><?php echo $dataDefFixes; ?></td>
                            </tr>
                            <tr>
                                <td>Data Def. Fails</td>
                                <td><?php echo $dataDefFails; ?></td>
                            </tr>
                            <tr>
                                <td>Data Def. Rep.</td>
                                <td><?php echo $dataDefReputation; ?></td>
                            </tr>
                        </table>
    ...
    <div id="datadefenders" class="datadefenders hide">
        <div class="wholedd">
            ...
            <span>
                <div class="reportButton">Report</div>
            </span><span class="deleteThis">Under Construction!!!!!</span>
